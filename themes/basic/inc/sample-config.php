...
$opt_name = 'r_opt';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
    ...
    'menu_title'                => esc_html__( 'Контент главной', 'your-textdomain-here' ),
...
Redux::set_section(
    $opt_name,
    array(
        'title'      => esc_html__( 'FAQ', 'your-textdomain-here' ),
        'id'         => 'FAQ-container',
        'subsection' => false,
        'fields'     => array(
            array(
                'id'       => 'faq-title',
                'type'     => 'textarea',
                'title'    => esc_html__( 'FAQ заголовок'),
            ),
            array(
                'id'          => 'FAQ',
                'type'        => 'slides',
                'title'       => esc_html__( 'Список вопросов', 'your-textdomain-here' ),
                'placeholder' => array(
                    'title'       => esc_html__( 'Вопрос', 'your-textdomain-here' ),
                    'description' => esc_html__( 'Ответ', 'your-textdomain-here' ),
...
Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'Социалки, телефон, почта'),
        ...
        'fields'           => array(
            array(
                'id'       => 'phone',
                'type'     => 'text',
                'title'    => esc_html__( 'Телефон '),
            ),
            array(
                'id'       => 'phone2',
                'type'     => 'text',
                'title'    => esc_html__( 'Телефон2 '),
            ),
            array(
                'id'       => 'mail',
                'type'     => 'text',
            ...
            array(
                'id'       => 'address',
                'type'     => 'textarea',
                'title'    => esc_html__( 'Адрес'),
            ),
            array(
                'id'       => 'workhours',
                'type'     => 'text',
                'title'    => esc_html__( 'Рабочие часы'),
            ),
            array(
                'id'       => 'google_map',
                'type'     => 'text',
                'title'    => esc_html__( 'Ссылка на Google Maps'),
            ),
...
Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'Контактная форма с гепатологом'),
        'id'               => 'contact-form-1',
        'subsection'       => false,
        'fields'           => array(
            array(
                'id'       => 'contact-form-1-title',
                'type'     => 'text',
                'title'    => esc_html__( 'Тайтл'),
            ),
            array(
                'id'       => 'contact-form-1-subtitle',
                'type'     => 'textarea',
                'title'    => esc_html__( 'Сабтайтл '),
            ),
            array(
                'id'       => 'contact-form-1-text',
                'type'     => 'textarea',
                'title'    => esc_html__( 'Текст '),
            ),
            array(
                'id'       => 'contact-form-1-shortcode',
                'type'     => 'text',
                'title'    => esc_html__( 'Шорткод'),
            ),
            array(
                'id'       => 'contact-form-1-button-text',
                'type'     => 'text',
                'title'    => esc_html__( 'Текст кнопки'),
            ),
           array(
               'id'        => 'contact-form-1-image',
               'type'      => 'media',
...
Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'Баннер снизу'),
        'id'               => 'contact-form-2',
        'subsection'       => false,
        'fields'           => array(
            array(
                'id'       => 'contact-form-2-title',
                'type'     => 'textarea',
                'title'    => esc_html__( 'Тайтл'),
            ),
            array(
                'id'       => 'contact-form-2-subtitle',
                'type'     => 'textarea',
                'title'    => esc_html__( 'Сабтайтл '),
            ),
            array(
                'id'       => 'contact-form-2-text',
                'type'     => 'textarea',
                'title'    => esc_html__( 'Текст '),
            ),
           array(
                'id'        => 'contact-form-2-image',
                'type'      => 'media',
                'title'     => esc_html__( 'Изображение'),
            )
        ),
